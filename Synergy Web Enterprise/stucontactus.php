...
if(isset($_POST['send'])){
    ...
    if($answer == 5){
        ...
        header("Location:stucontactus.php?success=" . urlencode("Thank you for your inquiry, will get back to you as soon as possible!"));
        exit();
    ...
    header("Location:stucontactus.php?err=" . urlencode("Please check your answer!"));
    exit();
}
...
<body>
<div id="Holder">
<div id="header"><div align="right"><h4><br>Welcome: <strong><?php if(isset($_SESSION['username'])) {
...
<form action = "stucontactus.php "class="form-horizontal" role="form" method="post" action="index.php">
