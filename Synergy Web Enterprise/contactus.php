...
if(isset($_POST['send'])){
    ...
    if($answer == 5){
        ...
        header("Location:contactus.php?success=" . urlencode("Thank you for your inquiry, will get back to you as soon as possible!"));
        exit();
    ...
    header("Location:contactus.php?err=" . urlencode("Please check your answer!"));
    exit();
}
...
<form action = "contactus.php "class="form-horizontal" role="form" method="post" action="index.php">
